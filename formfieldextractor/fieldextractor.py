...
class FormFieldExtractor:
    ...
    def __init__(self, image_path):
        """
        Initialize the FormFieldExtractor.
    ...
    def extract_lines(self):
        ...
        try:
            ...
            self.logger.error(f"Error during line extraction: {str(e)}")
    ...
    def count_characters(recorte):
        ...
        try:
            ...
            logging.error(f"Error during character counting: {str(e)}")
            return 0
    ...
    def count_words(recorte):
        ...
        try:
            ...
            logging.error(f"Error during word counting: {str(e)}")
            return 0
    ...
    def extract_form_fields(self):
        ...
        try:
            ...
            logging.error(f"Error during form field extraction: {str(e)}")
            return []
